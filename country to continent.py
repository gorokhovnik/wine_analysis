...
countries = [
    ...
    {'timezones': ['Asia/Shanghai', 'Asia/Harbin', 'Asia/Chongqing', 'Asia/Urumqi', 'Asia/Kashgar'], 'code': 'CN',
     'continent': 'Asia', 'name': 'China', 'capital': 'Beijing'},
...
africa = countries.sort_values('name')[countries['continent'] == 'Africa']['name'].values.tolist()
asia = countries.sort_values('name')[countries['continent'] == 'Asia']['name'].values.tolist()
europe = countries.sort_values('name')[countries['continent'] == 'Europe']['name'].values.tolist()
north_america = countries.sort_values('name')[countries['continent'] == 'North America']['name'].values.tolist()
