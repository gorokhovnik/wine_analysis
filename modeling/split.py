...
def split(wine, description='description', features=[], y='', test_size=0.2, tfidf=None, dictv=None):
    ...
    X_train_f = dictv.fit_transform(X_train_f)
    X_test_f = dictv.transform(X_test_f)
    X_f = dictv.transform(X_f)
